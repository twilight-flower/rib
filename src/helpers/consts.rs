pub static XHTML_ENTITIES: [(&str, &str); 2125] = [
    // XHTML entities, from https://www.w3.org/TR/xhtml1/dtds.html#h-A2
    // Latin-1 characters
    ("nbsp", "\u{a0}"),
    ("iexcl", "\u{a1}"),
    ("cent", "\u{a2}"),
    ...
    ("hearts", "\u{2665}"),
    ("diams", "\u{2666}"),
    // HTML5 entities, from https://html.spec.whatwg.org/multipage/named-characters.html#named-character-references, filtered to omit any already defined in the XHTML DTDs
    ("AMP", "\u{26}"),
    ("Abreve", "\u{102}"),
    ("Acy", "\u{410}"),
    ("Afr", "\u{1d504}"),
